...
describe('env.config', () => {
  describe('ENV_CONFIG', () => {
    it('should have all required properties', () => {
      ...
      expect(ENV_CONFIG).toHaveProperty('openAiCompatibleGatewayUrl')
      ...
      expect(ENV_CONFIG).toHaveProperty('hasOpenAiCompatibleGateway')
    ...
    it('should have boolean feature flags', () => {
      ...
      expect(typeof ENV_CONFIG.hasOpenAiCompatibleGateway).toBe('boolean')
    })
  })
