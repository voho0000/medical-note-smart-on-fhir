 ...
 * branch ships the heart-failure and coronary packs. A pack
...
/** HF stays first; the independently developed coronary pack is available beside it. */
const HOST_PACK_ORDER = ['heart-failure-cdss', 'chronic-coronary-disease-cdss'] as const
