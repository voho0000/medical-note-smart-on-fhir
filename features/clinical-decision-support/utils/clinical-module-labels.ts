...
export const CLINICAL_MODULE_LABELS: Readonly<Record<string, ClinicalModuleLabel>> = {
  ...
  'ckd-sglt2-strategy': { zh: 'SGLT2 抑制劑', en: 'SGLT2 inhibitor' },
  'ckd-finerenone-strategy': { zh: 'Finerenone', en: 'Finerenone' },
  'ckd-cardiovascular-risk': { zh: '心血管與血脂管理', en: 'Cardiovascular and lipid management' },
  'ckd-medication-safety': { zh: '腎功能用藥安全', en: 'Kidney medication safety' },
  'ckd-anemia-monitoring': { zh: '貧血監測', en: 'Anemia monitoring' },
  'ckd-potassium-acidosis': { zh: '血鉀與酸鹼', en: 'Potassium and acid-base status' },
  'ckd-mbd-monitoring': { zh: 'CKD 礦物質與骨代謝（CKD-MBD）', en: 'CKD mineral and bone disorder (CKD-MBD)' },
