...
export const ENV_CONFIG = {
  ...
  openAiCompatibleGatewayUrl: process.env.NEXT_PUBLIC_OPENAI_COMPATIBLE_GATEWAY_URL || '',
  perplexityProxyUrl: process.env.NEXT_PUBLIC_PERPLEXITY_PROXY_URL || '',
  ...
  hasOpenAiCompatibleGateway: Boolean(process.env.NEXT_PUBLIC_OPENAI_COMPATIBLE_GATEWAY_URL),
