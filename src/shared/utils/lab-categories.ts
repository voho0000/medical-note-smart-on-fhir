...
export function categorizeObservation(obs: any): LabCategory | null {
  ...
  const ANTIBIOTIC_RE = new RegExp(
    [
      ...
      // Beta-lactams & combos
      'PIPERACILLIN', 'TAZOBACTAM', 'SULBACTAM', 'AMPICILLIN', 'AMOXICILLIN',
      'CEFTRIAXONE', 'CEFTAZIDIME', 'CEFEPIME', 'CEFAZOLIN', 'CEFUROXIME',
      'CEFMETAZOLE', 'CEFOPERAZONE', 'CEFOTAXIME', 'CEFOXITIN', 'CEFIXIME',
      'CEFTOLOZANE', 'CEFIDEROCOL', 'CEPHALEXIN', 'CEPHAZOLIN',
      'FLOMOXEF', 'AZTREONAM', 'OXACILLIN', 'NAFCILLIN', 'METHICILLIN',
      // Other antibiotics
