...
export const en = {
  ...
  medicalSummary: {
    ...
    autoGenerateTooltip: 'Generate once automatically when a patient loads (cached 12h, not re-billed)',
    ...
    patient: {
      ...
      decisionsTitle: 'Things to discuss with your doctor',
