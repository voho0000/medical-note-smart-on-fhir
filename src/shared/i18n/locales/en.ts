...
export const en = {
  ...
  agent: {
    ...
    systemPrompt: {
      ...
      useToolsWhenNeeded: 'Only use tools to query additional data when more detailed or specific information is needed. You can use multiple tools together (e.g., query FHIR data first, then search medical literature)',
      useToolsDirectly: 'Use tools to query the required patient data directly. You can use multiple tools together (e.g., query FHIR data first, then search medical literature)',
