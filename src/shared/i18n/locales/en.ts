...
export const en = {
  ...
  onboarding: {
    ...
    autoScanTitle: 'Automatic safety insights',
    autoScanBody: 'When a patient loads, automatically run an AI scan for medication-safety issues. This uses your AI quota (the free allowance when not signed in). You can turn it on or off any time in Clinical Insights.',
    autoScanOnLabel: 'On',
    autoScanOnDesc: 'Scan automatically after a patient loads',
    autoScanOffLabel: 'Off',
    autoScanOffDesc: 'Scan manually when you need it',
