...
export const en = {
  ...
  agent: {
    ...
    systemPrompt: {
      ...
      useToolsWhenNeeded: 'Only use tools to query additional data when more detailed or specific information is needed. **IMPORTANT: If the question involves both patient data AND medical literature/guidelines, use BOTH tools** (e.g., query FHIR for patient data first, then use searchMedicalLiterature for treatment guidelines or latest research)',
      useToolsDirectly: 'Use tools to query the required patient data directly. **IMPORTANT: If the question involves both patient data AND medical literature/guidelines, use BOTH tools** (e.g., query FHIR for patient data first, then use searchMedicalLiterature for treatment guidelines or latest research)',
