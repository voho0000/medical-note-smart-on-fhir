...
export const en = {
  ...
  onboarding: {
    ...
    welcomeBody: 'A SMART-on-FHIR assistant that helps you read clinical data and draft notes with AI.',
    privacyTitle: 'Your privacy',
    privacyPoints: [
      'Patient data stays in your browser — it is never uploaded to our servers.',
      'AI features call cloud services (OpenAI / Gemini). Avoid entering highly sensitive personal identifiers.',
      'You can clear the loaded data at any time.',
    ],
    autoScanTitle: 'Let AI generate content automatically?',
    autoScanBody: 'When a patient loads, AI can automatically generate the Medical Summary and medication-safety alerts, so the highlights are ready the moment you open the chart. You can adjust each switch later in the Medical Summary tab.',
    autoScanPrivacyNote: 'Note: with auto-generate on, the loaded patient record is sent to cloud AI services (OpenAI / Gemini) for analysis as soon as a patient loads — without asking again.',
    autoScanOnLabel: 'Auto-generate (recommended)',
    autoScanOnDesc: 'Generate the summary and safety alerts when a patient loads',
    autoScanOffLabel: 'I’ll do it myself',
    autoScanOffDesc: 'Generate only when you press the button',
    signInTitle: 'Sign in or continue as guest',
    signInBody: 'Signing in is optional — you can start right away as a guest.',
    signInBenefitsTitle: 'Signing in lets you:',
    signInBenefits: [
      'Keep and sync your conversation history',
      'Get a higher daily AI allowance',
      'Auto-generate the AI summary and safety alerts on load',
    ],
    signInCta: 'Sign in',
    guestCta: 'Continue as guest',
    guestHint: 'You are currently using the app as a guest, with a limited free allowance.',
  },
}
