...
export const en = {
  ...
  settings: {
    ...
    perplexityKeyHelp: 'Used for medical literature search in Deep Mode. Your Perplexity API key is kept in local storage on this device only and never uploaded to servers.',
    saveKey: 'Save key',
    clear: 'Clear',
