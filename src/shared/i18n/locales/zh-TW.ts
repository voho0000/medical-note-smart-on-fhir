...
export const zhTW = {
  ...
  agent: {
    ...
    systemPrompt: {
      ...
      useToolsWhenNeeded: '只有在需要更詳細或特定的資訊時，才使用工具查詢額外資料。你可以同時使用多個工具（例如：先查詢 FHIR 資料，再搜索相關醫學文獻）',
      useToolsDirectly: '直接使用工具查詢所需的病人資料。你可以同時使用多個工具（例如：先查詢 FHIR 資料，再搜索相關醫學文獻）',
