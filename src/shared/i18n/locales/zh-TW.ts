...
export const zhTW = {
  ...
  onboarding: {
    ...
    autoScanBody: '啟用後，每次載入病人，系統會自動產生「醫療摘要」。您可以稍後在醫療摘要頁調整設定。',
    autoScanPrivacyNote: '啟用後，載入病人時會自動將產生內容所需的病歷資料傳送至您選擇的雲端 AI 服務，不會再逐次詢問。',
    autoScanOnLabel: '自動產生',
    autoScanOnDesc: '載入病人後自動產生醫療摘要',
    autoScanOffLabel: '需要時手動產生',
    autoScanOffDesc: '只有按下「產生摘要」時才會傳送資料',
    autoScanConsent: '我了解並同意：自動產生醫療摘要時，相關病歷資料會傳送至雲端 AI 服務。',
