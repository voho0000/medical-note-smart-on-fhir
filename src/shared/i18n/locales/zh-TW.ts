...
export const zhTW = {
  ...
  reports: {
    ...
    // zh-TW subgroup headers show bilingual "中文 · English" for clinical clarity
    cumulativeSubgroups: {
      counts: '計數 · Counts',
      indices: '紅血球指數 · RBC Indices',
      diff: '白血球分類 · Differential',
      renal: '腎功能 · Renal',
      electrolyte: '電解質 · Electrolytes',
      liver: '肝功能 · Liver',
      cardiac: '心肌酵素 · Cardiac',
      inflam: '發炎/感染 · Inflammation',
      iron: '鐵代謝 · Iron Studies',
      thyroid: '甲狀腺 · Thyroid',
      parathy: '副甲狀腺 · Parathyroid',
      adrenal: '腎上腺 · Adrenal',
      sexhorm: '性荷爾蒙 · Sex Hormones',
      pancreas: '胰島 · Pancreas',
      pituitary: '生長激素 · Pituitary/GH',
      physical: '物理性狀 · Physical',
      chemical: '化學分析 · Chemistry',
      micro: '顯微鏡檢 · Microscopy',
      ratio: '尿蛋白/肌酸酐比值 · Spot Ratios',
    },
    labels: {
      status: '狀態：',
      category: '類別：',
