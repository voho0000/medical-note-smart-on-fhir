...
export const zhTW = {
  ...
  onboarding: {
    ...
    autoScanTitle: '要讓 AI 自動產生內容嗎？',
    autoScanBody: '載入病人後，AI 可以自動產生「醫療摘要」與「用藥安全警示」，一打開就看到重點。之後隨時可以在醫療摘要分頁裡個別調整。',
    autoScanPrivacyNote: '提醒：選擇自動產生後，載入病人時就會將病歷資料傳送至雲端 AI（OpenAI / Gemini）分析，不會再另外詢問。',
    autoScanOnLabel: '自動產生（建議）',
    autoScanOnDesc: '載入病人後，自動產生摘要與安全警示',
    autoScanOffLabel: '我自己按',
    autoScanOffDesc: '需要時再按「產生摘要」或「掃描」',
