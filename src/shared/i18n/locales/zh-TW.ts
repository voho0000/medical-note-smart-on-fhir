...
export const zhTW = {
  ...
  agent: {
    ...
    systemPrompt: {
      ...
      useToolsWhenNeeded: '只有在需要更詳細或特定的資訊時，才使用工具查詢額外資料。**重要：如果問題涉及病人資料和醫學文獻/指引，請同時使用兩種工具**（例如：先查詢 FHIR 獲取病人資料，再用 searchMedicalLiterature 查詢相關的治療指引或最新研究）',
      useToolsDirectly: '直接使用工具查詢所需的病人資料。**重要：如果問題涉及病人資料和醫學文獻/指引，請同時使用兩種工具**（例如：先查詢 FHIR 獲取病人資料，再用 searchMedicalLiterature 查詢相關的治療指引或最新研究）',
