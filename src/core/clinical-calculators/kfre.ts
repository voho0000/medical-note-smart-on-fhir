 ...
 *
 * Vendored into the app on 2026-09-10. It used to re-export the governed
 * `@voho0000/personalized-care` implementation, but that package now ships the
 * heart-failure pathway alone and no longer carries the CKD guideline pack or
 * this calculator. The medical-calculator tab still offers KFRE, so the model
 * lives here; there is no CKD decision card left for it to disagree with.
 *
 * Model:
